   ...
   <body>
                  ...
                  <table class="table table-striped table-hover table-bordered" id="table_id"  cellspacing=0>
                     <thead>
                        <tr class="success">
                           ...
                           <th rowspan='2' style="text-align:center;">Judul <i class="fas fa-exchange-alt"></i></th>
                           <th rowspan='2' style="text-align:center;">SKU <i class="fas fa-exchange-alt"></th>
                           <th rowspan='2' style="text-align:center;" class='th-kategori'>Kategori <i class="fas fa-exchange-alt"></i></th>
                           ...
                           <th rowspan='2' style="text-align:center;">Link</th>
      ...
      <script>
         ...
         $(document).ready(function() {
            ...
            $('#table_id').dataTable({
                  "sAjaxSource" : 'JSON_data_tes2.php',
                  "searching": true,
                  "mark": true,
                  "scrollX":true,
                  // "order"  : [9,'desc'],
                  ...
                  createdRow: function(row, data, dataIndex){
                     $('td:eq(4)', row).attr('colspan', 3);
                    
                     $('td:eq(5)', row).css('display', 'none');
                     $('td:eq(6)', row).css('display', 'none');

                     $('td:eq(7)', row).attr('colspan', 2);
         ...
         function buka_harga_luar(id){
           $.get( "harga2.php?id="+id+'&luar=1', function( data ) {
            $("#"+id+'_luar').html(data);
           });
         }
