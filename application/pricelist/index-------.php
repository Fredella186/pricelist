            ...
            <div class="row">
               <div class="col-lg-12" style="overflow:hidden">
                  <span style="color: #e74c3c;
                     ...
                     display: block;
                     padding-top: 4px;">Tersedia di Kota Surabaya, Jakarta, Bandung, Makasar</span>

                  <table class="table table-striped table-hover table-bordered" id="table_id"  cellspacing=0 style='margin-top:5px'>
                     <thead>
                        <tr class="success">
