  ...
  <table class="table table-striped table-hover table-bordered" cellpadding="0" cellspacing="0">
      <thead>
        <tr class="success">
          ...
          <th style="text-align:center;">Link Bukalapak SBY</th>
      ...
      <tbody>
        <?php
          ...
          SELECT p.judul_produk, bl.kode_produk, ktg.nama_ktg, bl.id, bl.link, bl.update_time FROM link_bl_sby bl
          ...
          if(isset($_POST['src'])) {
              ...
              if(ctype_digit($kunci)){
                $q = "SELECT p.judul_produk, bl.kode_produk, ktg.nama_ktg, bl.id, bl.link, bl.update_time FROM link_bl_sby bl
                INNER JOIN tb_pricelist p ON p.kode_produk = bl.kode_produk
              ...
              $link = mysql_query("SELECT p.judul_produk, bl.kode_produk, ktg.nama_ktg, bl.id, bl.link, bl.update_time FROM link_bl_sby bl
                INNER JOIN tb_pricelist p ON p.kode_produk = bl.kode_produk
...
<script type="text/javascript">
  ...
  $('.edit').on("click", function(){
      ...
      var id_bl = this.id;
      if(id_bl != 0)
          $("#myModalLabel").html("Ubah Data Link Bukalapak SBY");
