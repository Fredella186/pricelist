  ...
  <table class="table table-striped table-hover table-bordered" cellpadding="0" cellspacing="0">
      <thead>
        <tr class="success">
          ...
          <th style="text-align:center;">Link Toped JKT 1</th>
          <th style="text-align:center;">Link Toped JKT 2</th>
      ...
      <tbody>
        <?php
          ...
          SELECT p.judul_produk, tpd.kode_produk, ktg.nama_ktg, tpd.id, tpd.link_1, tpd.link_2, tpd.update_time FROM link_toped_jkt tpd
          ...
          if(isset($_POST['src'])) {
              ...
              if(ctype_digit($kunci)){
                $q = "SELECT p.judul_produk, tpd.kode_produk, ktg.nama_ktg, tpd.id, tpd.link_1, tpd.link_2, tpd.update_time FROM link_toped_jkt tpd
                  INNER JOIN tb_pricelist p ON p.kode_produk = tpd.kode_produk
              ...
              $link = mysql_query("SELECT p.judul_produk, tpd.kode_produk, ktg.nama_ktg, tpd.id, tpd.link_1, tpd.link_2, tpd.update_time FROM link_toped_jkt tpd
                INNER JOIN tb_pricelist p ON p.kode_produk = tpd.kode_produk
