				...
				if($hrg_prod != $hrg_lama || $txt_gbr_prod != $gambar_lama){
                    ...
                    $message .= "</tr>
                            ...
                            <p align='justify'>
                                ...
                                <br/>
                                Terima kasih, <br/>
                                <p style='color:red; font-size:15px; font-weight:700; background:yellow;'>By: ".$_SESSION['user']."</p>
                            </p>
                        </body>
                    </html>";
                    ...
                    $subj_mail  = "[".$_SESSION['user']."][UPDATE] Harga Utama Produk FastPrint ".$judul_prod." di Price List";
                    //$kirim = sendMail($mail_to, $from_name, $from_mail, $cc, $subj_mail, $message);
                    //var_dump($kirim);
                    // echo kirimEmail($subj_mail, $message);
                	// kirim_skype($notip_baru);
                }
                else if($k != $hrg || $txt_gbr_prod != $gambar_lama){
                    ...
                    $from_name  = "Admin PL Fast Print Indonesia";
                    $from_mail  = "sales@fastprint.co.id";
                    $subj_mail  = "[".$_SESSION['user']."][UPDATE] Harga Tingkat Produk FastPrint ".$judul_prod." di Price List";
                    //$kirim = sendMail($mail_to, $from_name, $from_mail, $cc, $subj_mail, $message);
                    //var_dump($kirim);
                    $notip_baru .= "\n\n http://pcls.fastprint.co.id/plfp-backedit";					
                	$notip_baru .= "\n\n ".date("Y-m-d H:i:s")."\n oleh ".$_SESSION['user'];
