(function($) {
    ...
    $(document).ready(function(e) { 
        ...
        if(localStorage.getItem("cari-text")){
            $("input:text[name=cari]").val(localStorage.getItem("cari-text"))
            
            $.post(main, {cari: localStorage.getItem("cari-text")} ,function(data) {
        ...
        $('input:text[name=cari]').on('keyup',function(e){
            ...
            localStorage.setItem("cari-text",v_cari);
