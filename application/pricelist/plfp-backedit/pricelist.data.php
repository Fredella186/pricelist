  ...
  <table class="table table-striped table-hover table-bordered" cellpadding="0" cellspacing="0">
      ...
      <tr>
          ...
          if ($_SESSION['menu_toko'] == 1 && $_SESSION['kota'] == 'PUSAT') {
            ?>
                <th class="sticky-midle" group="col" style="text-align:center; background-color: #22ABD8;width:80px"> <?=($_SESSION['menu_toko'] == 1)?"PST":$_SESSION['toko']?></th>
                <th class="sticky-midle" group="col" style="text-align:center; background-color: #22ABD8;width:80px"> <?=($_SESSION['menu_toko'] == 1)?"JKT":$_SESSION['JKT']?></th>
                <th class="sticky-midle" group="col" style="text-align:center; background-color: #22ABD8;width:80px"> <?=($_SESSION['menu_toko'] == 1)?"BDG":$_SESSION['BDG']?></th>
                <th class="sticky-midle" group="col" style="text-align:center; background-color: #22ABD8;width:80px"> <?=($_SESSION['menu_toko'] == 1)?"BKS":$_SESSION['BKS']?></th>
                <th class="sticky-midle" group="col" style="text-align:center; background-color: #22ABD8;width:80px"> <?=($_SESSION['menu_toko'] == 1)?"MKS":$_SESSION['MKS']?></th>
                <th class="sticky-midle" group="col" style="text-align:center; background-color: #22ABD8;width:80px"> <?=($_SESSION['menu_toko'] == 1)?"MDN":$_SESSION['MDN']?></th>
            <?php
            ...
            <?php   
              ...
              <?php   
               ...
               ?>
                <th class="sticky-midle" group="col" style="text-align:center; background-color: #22ABD8;"> <?=($_SESSION['menu_toko'] == 1)?$_SESSION['toko']:"PST"?></th>
                <th class="sticky-midle" group="col" style="text-align:center; background-color: #22ABD8;"> <?=($_SESSION['menu_toko'] == 1)?$_SESSION['toko']:"JKT"?></th>
                <th class="sticky-midle" group="col" style="text-align:center; background-color: #22ABD8;"> <?=($_SESSION['menu_toko'] == 1)?$_SESSION['toko']:"BDG"?></th>
                <th class="sticky-midle" group="col" style="text-align:center; background-color: #22ABD8;"> <?=($_SESSION['menu_toko'] == 1)?$_SESSION['toko']:"BKS"?></th>
                ...
                <th class="sticky-midle" group="col" style="text-align:center; background-color: #22ABD8;"> <?=($_SESSION['menu_toko'] == 1)?$_SESSION['toko']:"MDN"?></th>
            <?php
            }
          ?>
                ...
                <td colspan='6' style='text-align:center'>
                    <table class='table table-bordered' style='margin-bottom:0'>
                        <tr class='bg-success' style='color:white'>
                            ...
                            <td style='width:270px' >Jawa</td>
                            <td style='background:orange'>Luar Jawa</td>
                        </tr>
                        <tr>
                            <td>
                                <?php 
                    ...
                    <div id="accordion">
                        <div class="card">
                            ...
                            <h5 class="mb-0" style='margin: 0;'>
                                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse<?=$data['id_pricelist']; ?>" aria-expanded="false" aria-controls="collapse<?=$data['id_pricelist']; ?>">
                                   Harga Tingkat
                                </button>
                            </h5>
                            </div>
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-striped table-hover">
                                      <tr class="warning">
                                          ...
                                          <th style="text-align:center;background:#18bc9c;width: 225px;">Jawa</th>
                                          <th style="text-align:center;background:orange">Luar Jawa</th>
                                      </tr>
                                      <?php
                                          $qGrosir = mysql_query("SELECT rentang_qty, harga_wholesale,harga_wholesale_luar FROM tb_wholesale WHERE id_produk = '".$data['kode_produk']."' ORDER BY `harga_wholesale` desc   ");
